...
using System.IO;
    ...
    public class MoveCamera : MonoBehaviour
    {
        ...
        experimentalCondition ="cameraSpeed" + cameraSpeed.ToString() + "_"
                             + "fps" + fps.ToString();
        ...
        if (timeMs <= trialTime)
            {
                ...
                Vector3 targetPosition = captureCamera0.transform.position + direction * (SerialReader.lastSensorValue + 0.5f) * cameraSpeed * Time.fixedDeltaTime;
